...
class CloudDataUtil {
    ...
    private val buildingA1 = Building(
        ...
        latitude = 10.772701462858283, longitude = 106.66019496138084,
        enableIndoorFeature = true
    )
    ...
    private val buildingA2 = Building(
        ...
        latitude = 10.773121076582761, longitude = 106.66023251230108,
        enableIndoorFeature = true
    )
    ...
    private val buildingA5 = Building(
        ...
        latitude = 10.773346637878591, longitude = 106.65962776870246,
        enableIndoorFeature = true
    )
    ...
    private val buildingB1A = Building(
        ...
        latitude = 10.771826547407846, longitude = 106.65832461053223
    )
    private val buildingB1B = Building(
        ...
        latitude = 10.772011136356184, longitude = 106.65873554508323,
        enableIndoorFeature = true
    )
    ...
    private val buildingB2 = Building(
        ...
        starNum = 4.5,
        reviewNum = 300,
        desc = "Building B2. The Ho Chi Minh City University of Technology (abbreviation: HCMUT Vietnamese: Trường Đại học Bách khoa, Đại học Quốc gia Thành phố Hồ Chí Minh)[1] is a key member university of Vietnam National University, Ho Chi Minh City and is the flagship university in technology teaching and research activities in Vietnam.\n" +
                "\n" +
                "HCMUT is a center of technology - industry and management training. Up to May 2005, HCMUT has 11 faculties, 14 research and development (R&D) centers, 4 training centers, 10 functioning offices and one joint-stock company. During the past 40 years since Vietnam's unification, 60,000 Engineers and Bachelors have graduated from HCMUT. Up to now, HCMUT have trained 60,000 Engineers and Bachelors, more than 10,000 Masters and 200 Doctors.",
        latitude = 10.772103694079826, longitude = 106.65938622841499
    )
    ...
    private val buildingB3 = Building(
        ...
        buildingName = "Building B3",
        buildingId = "b3",
        campusName = "Ho Chi Minh City University of Technology",
        starNum = 4.7,
        reviewNum = 17,
        campusId = "hcmut",
        desc = "Building B3. The Ho Chi Minh City University of Technology (abbreviation: HCMUT Vietnamese: Trường Đại học Bách khoa, Đại học Quốc gia Thành phố Hồ Chí Minh)[1] is a key member university of Vietnam National University, Ho Chi Minh City and is the flagship university in technology teaching and research activities in Vietnam.\n" +
                "\n" +
                "HCMUT is a center of technology - industry and management training. Up to May 2005, HCMUT has 11 faculties, 14 research and development (R&D) centers, 4 training centers, 10 functioning offices and one joint-stock company. During the past 40 years since Vietnam's unification, 60,000 Engineers and Bachelors have graduated from HCMUT. Up to now, HCMUT have trained 60,000 Engineers and Bachelors, more than 10,000 Masters and 200 Doctors.",
        latitude = 10.772446770460679, longitude = 106.65830338880444,
        enableIndoorFeature = true
    )
    ...
    private val buildingB4 = Building(
        ...
        buildingName = "Building B4",
        buildingId = "b4",
        campusName = "Ho Chi Minh City University of Technology",
        campusId = "hcmut",
        desc = "Building B4. The Ho Chi Minh City University of Technology (abbreviation: HCMUT Vietnamese: Trường Đại học Bách khoa, Đại học Quốc gia Thành phố Hồ Chí Minh)[1] is a key member university of Vietnam National University, Ho Chi Minh City and is the flagship university in technology teaching and research activities in Vietnam.\n" +
                "\n" +
                "HCMUT is a center of technology - industry and management training. Up to May 2005, HCMUT has 11 faculties, 14 research and development (R&D) centers, 4 training centers, 10 functioning offices and one joint-stock company. During the past 40 years since Vietnam's unification, 60,000 Engineers and Bachelors have graduated from HCMUT. Up to now, HCMUT have trained 60,000 Engineers and Bachelors, more than 10,000 Masters and 200 Doctors.",
        latitude = 10.773139985762606, longitude = 106.65879893051519
    )
    ...
    private val buildingB6 = Building(
        ...
        buildingName = "Building B6",
        buildingId = "b6",
        campusName = "Ho Chi Minh City University of Technology",
        campusId = "hcmut",
        desc = "Building B6. The Ho Chi Minh City University of Technology (abbreviation: HCMUT Vietnamese: Trường Đại học Bách khoa, Đại học Quốc gia Thành phố Hồ Chí Minh)[1] is a key member university of Vietnam National University, Ho Chi Minh City and is the flagship university in technology teaching and research activities in Vietnam.\n" +
                "\n" +
                "HCMUT is a center of technology - industry and management training. Up to May 2005, HCMUT has 11 faculties, 14 research and development (R&D) centers, 4 training centers, 10 functioning offices and one joint-stock company. During the past 40 years since Vietnam's unification, 60,000 Engineers and Bachelors have graduated from HCMUT. Up to now, HCMUT have trained 60,000 Engineers and Bachelors, more than 10,000 Masters and 200 Doctors.",
        latitude = 10.773821071596409, longitude = 106.65926943400407,
        enableIndoorFeature = true
    )
    ...
    private val buildingGate1 = Building(
        ...
        desc = "The Main Gate. The Ho Chi Minh City University of Technology (abbreviation: HCMUT Vietnamese: Trường Đại học Bách khoa, Đại học Quốc gia Thành phố Hồ Chí Minh)[1] is a key member university of Vietnam National University, Ho Chi Minh City and is the flagship university in technology teaching and research activities in Vietnam.\n" +
                "\n" +
                "HCMUT is a center of technology - industry and management training. Up to May 2005, HCMUT has 11 faculties, 14 research and development (R&D) centers, 4 training centers, 10 functioning offices and one joint-stock company. During the past 40 years since Vietnam's unification, 60,000 Engineers and Bachelors have graduated from HCMUT. Up to now, HCMUT have trained 60,000 Engineers and Bachelors, more than 10,000 Masters and 200 Doctors.",
        latitude = 10.772079548412044, longitude = 106.65778534063087
    )
    ...
    private val buildingFootballPitch = Building(
        ...
        desc = "Football Pitch. The Ho Chi Minh City University of Technology (abbreviation: HCMUT Vietnamese: Trường Đại học Bách khoa, Đại học Quốc gia Thành phố Hồ Chí Minh)[1] is a key member university of Vietnam National University, Ho Chi Minh City and is the flagship university in technology teaching and research activities in Vietnam.\n" +
                "\n" +
                "HCMUT is a center of technology - industry and management training. Up to May 2005, HCMUT has 11 faculties, 14 research and development (R&D) centers, 4 training centers, 10 functioning offices and one joint-stock company. During the past 40 years since Vietnam's unification, 60,000 Engineers and Bachelors have graduated from HCMUT. Up to now, HCMUT have trained 60,000 Engineers and Bachelors, more than 10,000 Masters and 200 Doctors.",
        latitude = 10.772634797371165, longitude = 106.65934216813446
    )
    ...
    private val buildingB8 = Building(
        ...
        buildingName = "Building B8",
        buildingId = "b8",
        campusName = "Ho Chi Minh City University of Technology",
        campusId = "hcmut",
        desc = "Building B8. The Ho Chi Minh City University of Technology (abbreviation: HCMUT Vietnamese: Trường Đại học Bách khoa, Đại học Quốc gia Thành phố Hồ Chí Minh)[1] is a key member university of Vietnam National University, Ho Chi Minh City and is the flagship university in technology teaching and research activities in Vietnam.\n" +
                "\n" +
                "HCMUT is a center of technology - industry and management training. Up to May 2005, HCMUT has 11 faculties, 14 research and development (R&D) centers, 4 training centers, 10 functioning offices and one joint-stock company. During the past 40 years since Vietnam's unification, 60,000 Engineers and Bachelors have graduated from HCMUT. Up to now, HCMUT have trained 60,000 Engineers and Bachelors, more than 10,000 Masters and 200 Doctors.",
        latitude = 10.773815946620921, longitude = 106.66038915792379,
        enableIndoorFeature = true
    )
    ...
    private val buildingB9 = Building(
        ...
        campusName = "Ho Chi Minh City University of Technology",
        campusId = "hcmut",
        desc = "Building B9. The Ho Chi Minh City University of Technology (abbreviation: HCMUT Vietnamese: Trường Đại học Bách khoa, Đại học Quốc gia Thành phố Hồ Chí Minh)[1] is a key member university of Vietnam National University, Ho Chi Minh City and is the flagship university in technology teaching and research activities in Vietnam.\n" +
                "\n" +
                "HCMUT is a center of technology - industry and management training. Up to May 2005, HCMUT has 11 faculties, 14 research and development (R&D) centers, 4 training centers, 10 functioning offices and one joint-stock company. During the past 40 years since Vietnam's unification, 60,000 Engineers and Bachelors have graduated from HCMUT. Up to now, HCMUT have trained 60,000 Engineers and Bachelors, more than 10,000 Masters and 200 Doctors.",
        latitude = 10.77357392665435, longitude = 106.66051650474452,
        enableIndoorFeature = true
    )
    ...
    private val buildingC1 = Building(
        ...
        campusName = "Ho Chi Minh City University of Technology",
        campusId = "hcmut",
        desc = "Building c1. The Ho Chi Minh City University of Technology (abbreviation: HCMUT Vietnamese: Trường Đại học Bách khoa, Đại học Quốc gia Thành phố Hồ Chí Minh)[1] is a key member university of Vietnam National University, Ho Chi Minh City and is the flagship university in technology teaching and research activities in Vietnam.\n" +
                "\n" +
                "HCMUT is a center of technology - industry and management training. Up to May 2005, HCMUT has 11 faculties, 14 research and development (R&D) centers, 4 training centers, 10 functioning offices and one joint-stock company. During the past 40 years since Vietnam's unification, 60,000 Engineers and Bachelors have graduated from HCMUT. Up to now, HCMUT have trained 60,000 Engineers and Bachelors, more than 10,000 Masters and 200 Doctors.",
        latitude = 10.774772406307, longitude = 106.65962566343943,
        enableIndoorFeature = true
    )

    private val buildingGate2 = Building(
        starNum = 4.3,
        reviewNum = 18,
        ...
        desc = "Gate 2. The Ho Chi Minh City University of Technology (abbreviation: HCMUT Vietnamese: Trường Đại học Bách khoa, Đại học Quốc gia Thành phố Hồ Chí Minh)[1] is a key member university of Vietnam National University, Ho Chi Minh City and is the flagship university in technology teaching and research activities in Vietnam.\n" +
                "\n" +
                "HCMUT is a center of technology - industry and management training. Up to May 2005, HCMUT has 11 faculties, 14 research and development (R&D) centers, 4 training centers, 10 functioning offices and one joint-stock company. During the past 40 years since Vietnam's unification, 60,000 Engineers and Bachelors have graduated from HCMUT. Up to now, HCMUT have trained 60,000 Engineers and Bachelors, more than 10,000 Masters and 200 Doctors.",
        latitude = 10.772746929298727, longitude = 106.66060902481368
    )
    ...
    private val buildingBasketballPitch = Building(
        ...
        desc = "Basketball Pitch. The Ho Chi Minh City University of Technology (abbreviation: HCMUT Vietnamese: Trường Đại học Bách khoa, Đại học Quốc gia Thành phố Hồ Chí Minh)[1] is a key member university of Vietnam National University, Ho Chi Minh City and is the flagship university in technology teaching and research activities in Vietnam.\n" +
                "\n" +
                "HCMUT is a center of technology - industry and management training. Up to May 2005, HCMUT has 11 faculties, 14 research and development (R&D) centers, 4 training centers, 10 functioning offices and one joint-stock company. During the past 40 years since Vietnam's unification, 60,000 Engineers and Bachelors have graduated from HCMUT. Up to now, HCMUT have trained 60,000 Engineers and Bachelors, more than 10,000 Masters and 200 Doctors.",
        latitude = 10.774140037010868, longitude = 106.65966283443115
    )
    ...
    /**
     * Update all building info in HCMUT
     */
        ...
        for (i in list) {
            db.collection(Constant.CAMPUS).document(HCMUT).collection(Constant.BUILDING_INFO)
                .document(i.buildingId.toString()).set(i, SetOptions.merge()).addOnSuccessListener {
                    Log.d("MetaMap uploaded: ", i.buildingId.toString())
                }
        }
    }

    fun updateEntertainmentVenues() {
        updateBuildingInfoData()
    ...
    /**
     * Update a building info
     */
    fun updateBuilding(building: Building) {
        db.collection(Constant.CAMPUS).document(Constant.HCMUT)
            .collection(Constant.BUILDING_INFO)
            .document(building.buildingId ?: "").set(building, SetOptions.merge())
            .addOnSuccessListener {
                Log.d("MetaMap uploaded","$building")
            }
    }
}
...
class BuildingRoom {
    ...
    private val a4Rooms: HashMap<String, List<String>> = hashMapOf()

    fun postRoom() {
        a4Rooms["a4"] = mutableListOf("401, 402, 403, 404, 405, 406, 407, 408, 409, 410")
        db.collection(Constant.CAMPUS).document(Constant.HCMUT).collection(Constant.BUILDING_INFO)
            .document("a4").set(a4Rooms["a4"]!!, SetOptions.merge())
    }
}
